...
class SigmoidFocalLoss(nn.Module):
    ...
    @staticmethod
    def sigmoid_tune(cls_flat):
        cls_flat[cls_flat < -60.] = -60.
        cls_flat[cls_flat > 14.] = 14.
        return cls_flat

    def forward(self, out, target):
        out = self.sigmoid_tune(out)
        n_class = out.shape[1]
...
class FCOSLoss(nn.Module):
    ...
    def prepare_target(self, points, targets):
        # points: featuremap mapping point
        # targets: boxlist.Boxlist
        ex_size_of_interest = []
    ...
    def compute_centerness_targets(self, box_targets):
        ...
        return torch.sqrt(centerness+1e-25)
